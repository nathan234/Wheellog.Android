...
class InmotionAdapterV2Test {
    ...
    fun `decode with v11 full data`() {
        ...
        val byteArray2 =
            "AAAA11178202313438304341313232323037303032420000000000FD".hexToByteArray() // s/n
        val byteArray3 =
            "AAAA111D820622080004030F000602214000010110000602230D00010107000001F3".hexToByteArray() //versions
        val byteArray4 =
            "AAAA141AA0207C15C800106464140000000058020000006400001500100010".hexToByteArray() // wtf
        val byteArray5 =
            "AAAA142B900001142614000000803E498AE00FB209D109CEB000C7DF010000BE720000AB1300008F040000AB0600004C".hexToByteArray() // probably statistics
        val byteArray6 =
            "AAAA141991E86C000066191C002DB2040064E60000974D050000C7DF01A4".hexToByteArray() // totals
        val byteArray7 =
            "AAAA143184E61EEB0561094A11AE04A004DF01402958CBB000CE004A010000D4FF7C15641900000000492B00000000000000000000C6".hexToByteArray()
...
// pc 1, mc 1, mot 1, chrg 0, light 1, decor 1, lifted 0, tail 1, fan 1
    ...
    fun `decode with v11 escape data`() {
        ...
        val byteArray1 =
            "aaaa1431843020a5a50068025207870080009400882c5fc4b000d7001000f4ff2b037c1564190000d9d9492b00000000000000000000a5a5".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
    ...
    fun `decode v11 new fw with PWM`() {
        ...
        adapter.setProto2(1)
        val byteArray1 =
            "aaaa143384411f8e03a5a506e90bd80242021600122a5acbb000cc002a0000000bfd7c1564190000d4d1ff09490a0000000000000000000010".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isTrue()
    ...
    fun `decode with v11 escape data2`() {
        ...
        adapter.setProto2(1)
        val byteArray1 =
            "aaaa143184a5aa1e8100640b1301650059001504a0234cc0b000ce00180000007c007c1564190000d1d3492b00000000000000000000a5a5".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isTrue()
    ...
    fun `decode with v11 v1_4_0`() {
        ...
        adapter.setProto2(2)
        val byteArray1 =
            "aaaa1445842d1d10000000efff070000000000000000002b0300000000000000008a149612e02e8813641900000000cbb000cccad1000028000000000049140000000000000000000021".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isTrue()
    ...
    fun `decode version with v11 v1_4_0`() {
        ...
        adapter.setModel2(Model.V11)
        val byteArray1 =
            "aaaa111d820622000003040300070221000004011a000602230d00010107000001b9".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isFalse()
    ...
    fun `decode version with v12`() {
        ...
        adapter.setModel2(Model.V11)
        val byteArray1 =
            "aaaa111d820622790002042000060221040005017d000602233700010203000402bb".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isFalse()
    ...
    fun `decode with v12 full data`() {
        ...
        val byteArray2 =
            "aaaa11178202413033313135353133303030393733300000000000fb".hexToByteArray() // s/n
        val byteArray3 =
            "aaaa111d820622700002042000060221180004017d000602232400010203000402bc".hexToByteArray() //versions
        val byteArray5 =
            "aaaa142b900001082608000000c1b55622330000000000cdceb0ce0000000000000000000000000000000008000000ce".hexToByteArray() // probably statistics
        val byteArray6 =
            "aaaa1419916350000074471800d1140400c68e00007d350200b0ce000039".hexToByteArray() // totals
        val byteArray7 =
            "aaaa144384cd26090000000e00040000000000000000000000eafb000062009d2450463b1b581b000000000000cdce00ced1d0b03d2828000000004900000000000000000000008c".hexToByteArray()
        // Act.
        val result1 = adapter.decode(byteArray1)
        val result2 = adapter.decode(byteArray2)
        val result3 = adapter.decode(byteArray3)
    ...
    fun `decode with v12 full data 2`() {
        ...
        val byteArray6 =
            "aaaa1419916350000074471800d1140400c68e00007d350200b0ce000039".hexToByteArray() // totals
        val byteArray7 =
            "aaaa144384ae24600479135909c61536085a0b00003f000000eb003700a5aa21b61f50463b1b581b000000000000ddd900dfe5e4b0f9646400000000490800000000000000000000dd".hexToByteArray()
        // Act.
        val result1 = adapter.decode(byteArray1)
        val result2 = adapter.decode(byteArray2)
        val result3 = adapter.decode(byteArray3)
    ...
    fun `decode with v12 data 3`() {
        ...
        val byteArray1 =
            "aaaa14438415273500930496014b0535003a0000008d000000fdfe010010271c255046581b581b000000000000ceca00cfd1d0b08d646400000000490000000000000000000000bc".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isTrue()
    ...
    fun `decode with v12 data 4`() {
        ...
        adapter.setModel2(Model.V12)
        val byteArray1 =
            "aaaa1443842627090000000000060000000000000000000000b3fd000010271c255046581b581b000000000000ceca00ced0cfb048282800000000490000000000000000000000ef".hexToByteArray() // wheel type
        // Act.
        val result1 = adapter.decode(byteArray1)
        // Assert.
        assertThat(result1).isTrue()
    ...
    fun `decode with v13 full data 1`() {
        ...
        val byteArray2 =
            "aaaa111782024130333131364231383030303130343600000000008a".hexToByteArray() // s/n
        val byteArray3 =
            "aaaa112f8206223a000005030008022115000002cf000802230a0002020000050224070001010200010125070001010200010172".hexToByteArray() //versions
        val byteArray5 =
            "aaaa142b9000010126010000004390a7d5010251000701cdcec9d000000000080000000000000004000000070000006c".hexToByteArray() // probably statistics
        val byteArray6 =
            "aaaa1419915e010000b7660000500900008c0600002d8b0000c9d000007e".hexToByteArray() // totals
        val byteArray7 =
            "aaaa145984092f3807000036003735000025130f27b108111d4203b00664fee703050000000000f225e225204e28233421401f401f204e401f709400000000cdccc9d1b0d10000b0286400000000004910000000000000001800000000b3".hexToByteArray()
